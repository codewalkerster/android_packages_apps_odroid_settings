...
public class PQResetAllActivity extends Activity {

    private static final String TAG = "PQResetAllActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            GuidedStepFragment.addAsRoot(this, PQResetAllFragment.newInstance(), android.R.id.content);
        }
    }

    public static class PQResetAllFragment extends GuidedStepFragment {

        public static PQResetAllFragment newInstance() {

            Bundle args = new Bundle();

            PQResetAllFragment fragment = new PQResetAllFragment();
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            return new GuidanceStylist.Guidance(
                    getString(R.string.pq_allreset_title),
                    getString(R.string.pq_allreset_description),
                    null,
        ...
        public void onCreateActions(@NonNull List<GuidedAction> actions,
            ...
            actions.add(new GuidedAction.Builder(getContext())
                    ...
                    .title(getString(R.string.pq_allreset_title))
                    .build());
        }
    ...
    public static class PQResetAllConfirmFragment extends GuidedStepFragment {
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            return new GuidanceStylist.Guidance(
                    getString(R.string.pq_allreset_title),
                    getString(R.string.pq_allreset_confirm_description),
                    null,
                    getContext().getDrawable(R.drawable.ic_settings_backup_restore_132dp));
        }
        ...
        private void performFactoryReset() {
            PQSettingsManager mPQSettingsManager = new PQSettingsManager(getActivity());
            mPQSettingsManager.SSMRecovery();
            Toast.makeText(getActivity(), R.string.pq_allreset_success, Toast.LENGTH_SHORT).show();
            getActivity().finish();
