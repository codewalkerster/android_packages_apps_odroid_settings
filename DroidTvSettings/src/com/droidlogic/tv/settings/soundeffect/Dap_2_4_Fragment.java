...
public class Dap_2_4_Fragment extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    private static final String KEY_DAP_2_4_BASS_ENHANCER_CUTOFF_100   = "key_dap_2_4_bass_enhancer_cutoffX100";
    private static final String KEY_DAP_2_4_BASS_ENHANCER_CUTOFF_1     = "key_dap_2_4_bass_enhancer_cutoffX1";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mBeCutoffX100Pref = (SeekBarPreference) findPreference(KEY_DAP_2_4_BASS_ENHANCER_CUTOFF_100);
        mBeCutoffX1Pref = (SeekBarPreference) findPreference(KEY_DAP_2_4_BASS_ENHANCER_CUTOFF_1);
        ...
        progressSuv = mAudioEffectManager.getDapParam(AudioEffectManager.CMD_DAP_2_4_SURROUND_VIRTUALIZER);
        if (progressSuv == 0) {
            mSuvPref.setSummary("OFF");
        } else if (progressSuv == 1) {
            mSuvPref.setSummary("ON");
        } else if (progressSuv == 2) {
            mSuvPref.setSummary("AUTO");
        }
        mSuvPref.setValueIndex(progressSuv);
    ...
    private void updateDetail() {
        ...
        val_cutoffX100 = mAudioEffectManager.getDapParam(AudioEffectManager.SUBCMD_DAP_2_4_BASS_ENHANCER_CUTOFF_100) / 100;
        val_cutoffX1 = mAudioEffectManager.getDapParam(AudioEffectManager.SUBCMD_DAP_2_4_BASS_ENHANCER_CUTOFF_1);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        switch (preference.getKey()) {
            ...
            case KEY_DAP_2_4_BASS_ENHANCER_BOOST:
                ...
                break;
            case KEY_DAP_2_4_BASS_ENHANCER_CUTOFF_100:
                mAudioEffectManager.setDapParam(AudioEffectManager.SUBCMD_DAP_2_4_BASS_ENHANCER_CUTOFF_100, (int)newValue);
                break;
            case KEY_DAP_2_4_BASS_ENHANCER_CUTOFF_1:
                mAudioEffectManager.setDapParam(AudioEffectManager.SUBCMD_DAP_2_4_BASS_ENHANCER_CUTOFF_1, (int)newValue);
                break;
