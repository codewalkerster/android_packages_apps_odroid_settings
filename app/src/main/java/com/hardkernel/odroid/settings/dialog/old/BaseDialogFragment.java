...
import com.hardkernel.odroid.settings.util.TransitionImage;
import com.hardkernel.odroid.settings.util.TransitionImageAnimation;
import com.hardkernel.odroid.settings.util.UriUtils;
