...
import com.hardkernel.odroid.settings.widget.BitmapWorkerOptions;
import com.hardkernel.odroid.settings.widget.DrawableDownloader;
...
public class TransitionImage {
    ...
    public static final String EXTRA_TRANSITION_BITMAP =
            "com.hardkernel.odroid.settings.transition_bitmap";
    public static final String EXTRA_TRANSITION_BITMAP_RECT =
            "com.hardkernel.odroid.settings.transition_bmp_rect";
    public static final String EXTRA_TRANSITION_BITMAP_URI =
            "com.hardkernel.odroid.settings.transition_bmp_uri";
    public static final String EXTRA_TRANSITION_BITMAP_ALPHA =
            "com.hardkernel.odroid.settings.transition_bmp_alpha";
    public static final String EXTRA_TRANSITION_BITMAP_SATURATION =
            "com.hardkernel.odroid.settings.transition_bmp_saturation";
    public static final String EXTRA_TRANSITION_BITMAP_BACKGROUND =
            "com.hardkernel.odroid.settings.transition_bmp_background";
    public static final String EXTRA_TRANSITION_BITMAP_UNCLIPPED_RECT =
            "com.hardkernel.odroid.settings.transition_bmp_unclipped_rect";
    public static final String EXTRA_TRANSITION_BITMAP_CLIPPED_RECT =
            "com.hardkernel.odroid.settings.transition_bmp_clipped_rect";
    public static final String EXTRA_TRANSITION_MULTIPLE_BITMAP =
            "com.hardkernel.odroid.settings.transition_multiple_bitmap";
