...
import static hardkernel.odroid.settings.device.displaysound.DisplaySoundUtils.getMatchContentDynamicRangeStatus;
import static hardkernel.odroid.settings.device.displaysound.DisplaySoundUtils.setMatchContentDynamicRangeStatus;
import static hardkernel.odroid.settings.overlay.FlavorUtils.FLAVOR_CLASSIC;
import static hardkernel.odroid.settings.overlay.FlavorUtils.FLAVOR_TWO_PANEL;
import static hardkernel.odroid.settings.overlay.FlavorUtils.FLAVOR_VENDOR;
import static hardkernel.odroid.settings.overlay.FlavorUtils.FLAVOR_X;
...
import hardkernel.odroid.settings.util.ResolutionSelectionUtils;
