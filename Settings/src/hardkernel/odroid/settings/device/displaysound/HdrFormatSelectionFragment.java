...
import static hardkernel.odroid.settings.device.displaysound.DisplaySoundUtils.isHdrFormatSupported;
import static hardkernel.odroid.settings.device.displaysound.HdrFormatSelectionInfo.AutoInfoFragment;
import static hardkernel.odroid.settings.device.displaysound.HdrFormatSelectionInfo.DolbyVisionNotSupportedFragment;
import static hardkernel.odroid.settings.device.displaysound.HdrFormatSelectionInfo.ManualInfoFragment;
