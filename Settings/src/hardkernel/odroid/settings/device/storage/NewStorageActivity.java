...
import hardkernel.odroid.settings.device.StorageResetActivity;
...
public class NewStorageActivity extends Activity {
    ...
    private static final String ACTION_NEW_STORAGE =
            "hardkernel.odroid.settings.device.storage.NewStorageActivity.NEW_STORAGE";
    private static final String ACTION_MISSING_STORAGE =
            "hardkernel.odroid.settings.device.storage.NewStorageActivity.MISSING_STORAGE";
