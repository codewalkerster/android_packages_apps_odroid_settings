...
package hardkernel.odroid.settings.device.storage;
...
public class SettingsStorageService {
    ...
    public static final String ACTION_FORMAT_AS_PUBLIC =
            "hardkernel.odroid.settings.device.storage.FORMAT_AS_PUBLIC";
    public static final String ACTION_FORMAT_AS_PRIVATE =
            "hardkernel.odroid.settings.device.storage.FORMAT_AS_PRIVATE";
    public static final String ACTION_UNMOUNT = "hardkernel.odroid.settings.device.storage.UNMOUNT";

    public static final String EXTRA_SUCCESS = "hardkernel.odroid.settings.device.storage.SUCCESS";
    public static final String EXTRA_INTERNAL_BENCH =
            "hardkernel.odroid.settings.device.storage.INTERNAL_BENCH";
    public static final String EXTRA_PRIVATE_BENCH =
            "hardkernel.odroid.settings.device.storage.PRIVATE_BENCH";
