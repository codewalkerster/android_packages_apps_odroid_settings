...
public class ConfirmLockdownFragment extends ObservableDialogFragment
    ...
    public static ConfirmLockdownFragment newInstance() {
        return new ConfirmLockdownFragment();
    }

    private ConfirmLockdownFragment() {
        super();
    }
