...
public class SettingsConstant {
    ...
    public static String PACKAGE = "hardkernel.odroid.settings";
    ...
    public static String PACKAGE_NAME_SOUNDEFFECT = "hardkernel.odroid.settings";
    public static String ACTIVITY_NAME_SOUNDEFFECT = "hardkernel.odroid.settings.soundeffect.AdvancedVolumeActivity";
