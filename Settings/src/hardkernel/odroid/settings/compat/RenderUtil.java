...
package hardkernel.odroid.settings.compat;

import static hardkernel.odroid.settings.compat.TsCollapsibleCategory.COLLAPSE;
    ...
    private static String getNextFragment(int nextState) {
        switch (nextState) {
            case STATE_WIFI_DETAILS:
                return "hardkernel.odroid.settings.connectivity.WifiDetailsFragmentCompat";
            case STATE_APP_MANAGEMENT:
                return "hardkernel.odroid.settings.device.apps.AppManagementFragmentCompat";
            case STATE_ACCESSIBILITY_SERVICE:
                return "hardkernel.odroid.settings.accessibility.AccessibilityServiceFragmentCompat";
            case STATE_STORAGE:
                return "hardkernel.odroid.settings.device.storage.StorageFragmentCompat";
            case STATE_MISSING_STORAGE:
                return "hardkernel.odroid.settings.device.storage.MissingStorageFragmentCompat";
            case STATE_APPS:
                return "hardkernel.odroid.settings.device.apps.AppsFragmentCompat";
            case STATE_EMPTY:
            default:
                return null;
        }
