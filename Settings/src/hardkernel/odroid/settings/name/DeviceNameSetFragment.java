...
package hardkernel.odroid.settings.name;
...
import hardkernel.odroid.settings.name.setup.DeviceNameFlowStartActivity;
import hardkernel.odroid.settings.util.GuidedActionsAlignUtil;
