...
package hardkernel.odroid.settings.advance_settings;
...
import hardkernel.odroid.settings.device.apps.AppManagementFragment;
import hardkernel.odroid.settings.display.DrmDisplaySetting;
import hardkernel.odroid.settings.util.ReflectUtils;
import java.util.ArrayList;
import java.util.Comparator;
import java.util.List;
import hardkernel.odroid.settings.advance_settings.performance.PerformanceService;
...
public class AdvanceSettingsFragment extends SettingsPreferenceFragment implements
    ...
    private static final String SERVICE_NAME = "hardkernel.odroid.settings.advance_settings.performance.PerformanceService";
