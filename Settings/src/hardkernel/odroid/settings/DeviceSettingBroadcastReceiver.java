...
import static hardkernel.odroid.settings.overlay.FlavorUtils.X_EXPERIENCE_FLAVORS_MASK;
...
public class DeviceSettingBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_REBOOT_DEVICE = "hardkernel.odroid.settings.REBOOT_DEVICE";
    private static final String ACTION_REMOVE_WIFI = "hardkernel.odroid.settings.REMOVE_WIFI";
