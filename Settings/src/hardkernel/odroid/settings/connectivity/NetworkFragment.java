...
import hardkernel.odroid.settings.RestrictedPreferenceAdapter;
...
import hardkernel.odroid.settings.vpn.GearPreference.OnGearClickListener;
import hardkernel.odroid.settings.widget.CustomContentDescriptionSwitchPreference;
import hardkernel.odroid.settings.widget.TvAccessPointPreference;
...
public class NetworkFragment extends SettingsPreferenceFragment implements
    ...
    private static final String NETWORK_DIAGNOSTICS_ACTION =
            "hardkernel.odroid.settings.network.NETWORK_DIAGNOSTICS";
