...
import hardkernel.odroid.settings.connectivity.setup.EasyConnectQRState;
...
public class AddWifiNetworkActivity extends InstrumentedActivity
    ...
    private static final String EXTRA_TYPE = "hardkernel.odroid.settings.connectivity.type";
