...
public class HotspotDialogActivity extends BaseInputActivity implements View.OnClickListener,
...
//  private final DialogInterface.OnClickListener mListener;
    ...
    private static final String TAG = "HotspotDialogActivity";
            ...
            switch (view.getId()) {
                case R.id.OK: {
                    ...
                    if (mWifiConfig != null) {
                        ...
                        HotspotFragment.mRestartWifiApAfterConfigChange = true;
                        Intent intent = new Intent();
                        intent.setAction(TetheringManager.ACTION_TETHER_STATE_CHANGED);
    ...
    private static final class OnStartTetheringCallback extends
        ...
        final WeakReference<HotspotDialogActivity> mTetherSettings;

        OnStartTetheringCallback(HotspotDialogActivity settings) {
            mTetherSettings = new WeakReference<HotspotDialogActivity>(settings);
        }
