...
package hardkernel.odroid.settings.sliceprovider.accessories;

import static android.app.PendingIntent.FLAG_IMMUTABLE;
import static android.app.PendingIntent.FLAG_UPDATE_CURRENT;
import static android.content.Intent.FLAG_RECEIVER_FOREGROUND;

import static  hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceBroadcastReceiver.ACTION_FIND_MY_REMOTE;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceBroadcastReceiver.ACTION_TOGGLE_CHANGED;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceBroadcastReceiver.ACTIVE_AUDIO_OUTPUT;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceBroadcastReceiver.BLUETOOTH_ON;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceBroadcastReceiver.EXTRA_TOGGLE_STATE;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceBroadcastReceiver.EXTRA_TOGGLE_TYPE;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceUtils.EXTRAS_SLICE_URI;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceUtils.FIND_MY_REMOTE_PHYSICAL_BUTTON_ENABLED_SETTING;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceUtils.isFindMyRemoteButtonEnabled;
