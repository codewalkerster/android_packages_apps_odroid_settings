...
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceProvider.KEY_EXTRAS_DEVICE;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceUtils.DIRECTION_BACK;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceUtils.EXTRAS_DIRECTION;
...
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceUtils.notifyDeviceChanged;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceUtils.notifyToGoBack;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceUtils.setFindMyRemoteButtonEnabled;
