...
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceProvider.KEY_BLUETOOTH_TOGGLE;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceProvider.KEY_CONNECT;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceProvider.KEY_DISCONNECT;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceProvider.KEY_EXTRAS_DEVICE;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceProvider.KEY_FORGET;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceProvider.KEY_RENAME;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceProvider.YES;
import static hardkernel.odroid.settings.sliceprovider.accessories.ConnectedDevicesSliceBroadcastReceiver.ACTION_BACK_AND_UPDATE_SLICE;
