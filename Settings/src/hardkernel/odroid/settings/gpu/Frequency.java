...
public class Frequency {
    private final static String GPU_PATH = "/sys/class/devfreq/fd000000.valhall";
    private final static String MAX_FREQ = GPU_PATH + "/max_freq";
    private final static String MIN_FREQ = GPU_PATH + "/min_freq";
    private final static String CUR_FREQ = GPU_PATH + "/cur_freq";
    private final static String AVAILABLE_FREQ = GPU_PATH + "/available_frequencies";
