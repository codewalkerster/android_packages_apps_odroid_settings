...
package hardkernel.odroid.settings.basic;
...
/**
 * An {@InfoFragment} that hosts preview pane of basic mode exit preference in suggested settings.
 */
@Keep
public class BasicModeExitSuggestionInfoFragment extends InfoFragment {
    ...
    public View onCreateView(
        ...
        ((TextView) view.findViewById(R.id.info_summary))
                .setText(R.string.basic_mode_exit_info_summary);
