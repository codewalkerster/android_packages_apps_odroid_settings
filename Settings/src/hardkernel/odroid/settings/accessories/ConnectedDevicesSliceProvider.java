...
import static hardkernel.odroid.settings.accessories.AddAccessoryActivity.ACTION_CONNECT_INPUT;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceBroadcastReceiver.ACTION_TOGGLE_CHANGED;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceBroadcastReceiver.BLUETOOTH_ON;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceBroadcastReceiver.EXTRA_TOGGLE_TYPE;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceUtils.EXTRAS_SLICE_URI;
