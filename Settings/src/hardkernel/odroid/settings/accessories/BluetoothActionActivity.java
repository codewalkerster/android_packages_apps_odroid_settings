...
package hardkernel.odroid.settings.accessories;

import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceProvider.KEY_BLUETOOTH_TOGGLE;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceProvider.KEY_CONNECT;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceProvider.KEY_DISCONNECT;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceProvider.KEY_EXTRAS_DEVICE;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceProvider.KEY_FORGET;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceProvider.KEY_RENAME;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceProvider.YES;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceUtils.DIRECTION_BACK;
import static hardkernel.odroid.settings.accessories.ConnectedDevicesSliceUtils.EXTRAS_DIRECTION;
