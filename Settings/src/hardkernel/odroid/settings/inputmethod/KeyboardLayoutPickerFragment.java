...
public class KeyboardLayoutPickerFragment extends SettingsPreferenceFragment
     ...
     */
    public static KeyboardLayoutPickerFragment newInstance() {
        return new KeyboardLayoutPickerFragment();
    }
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        root.setTitle(getString(R.string.keyboard_layout_picker_title));
