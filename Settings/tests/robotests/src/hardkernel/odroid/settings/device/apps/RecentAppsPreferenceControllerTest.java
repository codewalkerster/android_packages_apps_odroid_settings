...
import hardkernel.odroid.settings.testutils.ShadowIconDrawableFactory;
...
public class RecentAppsPreferenceControllerTest {
    ...
    public void setUp() {
        ...
        mController = new RecentAppsPreferenceController(mContext, mAppState);
    ...
    public void onDisplayAndUpdateState_shouldRefreshUi() {
        mController = spy(new RecentAppsPreferenceController(mContext, (Application) null));
    ...
    public void display_shouldNotShowRecents_showAllAppsPreference() {
        mController.displayPreference(mScreen);
    ...
    public void display_showRecents() {
        ...
        stat2.mPackageName = "hardkernel.odroid.settings";
        stats.add(stat2);
    ...
    @Test
    public void display_hasRecentButNoneDisplayable_showAllApps() {
        final List<UsageStats> stats = new ArrayList<>();
        final UsageStats stat1 = new UsageStats();
        final UsageStats stat2 = new UsageStats();
        stat1.mLastTimeUsed = System.currentTimeMillis();
        stat1.mPackageName = "com.android.systemui";
        stats.add(stat1);
