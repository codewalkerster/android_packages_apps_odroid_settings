...
import static hardkernel.odroid.settings.device.displaysound.HdrFormatSelectionFragment.KEY_HDR_FORMAT_PREFIX;
import static hardkernel.odroid.settings.device.displaysound.HdrFormatSelectionFragment.KEY_HDR_FORMAT_SELECTION_AUTO;
import static hardkernel.odroid.settings.device.displaysound.HdrFormatSelectionFragment.KEY_HDR_FORMAT_SELECTION_MANUAL;
import static hardkernel.odroid.settings.device.displaysound.HdrFormatSelectionFragment.KEY_SHOW_HIDE_FORMAT_INFO;
