...
import static hardkernel.odroid.settings.device.displaysound.AdvancedVolumeFragment.KEY_SHOW_HIDE_FORMAT_INFO;
import static hardkernel.odroid.settings.device.displaysound.AdvancedVolumeFragment.KEY_SURROUND_SOUND_AUTO;
import static hardkernel.odroid.settings.device.displaysound.AdvancedVolumeFragment.KEY_SURROUND_SOUND_FORMAT_PREFIX;
import static hardkernel.odroid.settings.device.displaysound.AdvancedVolumeFragment.KEY_SURROUND_SOUND_MANUAL;
import static hardkernel.odroid.settings.device.displaysound.AdvancedVolumeFragment.KEY_SURROUND_SOUND_NONE;
