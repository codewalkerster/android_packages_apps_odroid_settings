...
import hardkernel.odroid.settings.testutils.Utils;
...
public class DevicePrefFragmentTest {
    ...
    public void testUpdateCastSettings() {
        ...
        applicationInfo.packageName = "hardkernel.odroid.settings";
        ...
        resolveInfo.resolvePackageName = "hardkernel.odroid.settings";

        final PackageInfo packageInfo = new PackageInfo();
        packageInfo.applicationInfo = applicationInfo;
        packageInfo.packageName = "hardkernel.odroid.settings";
